...
var cloud = "cloud";
var rain = "rain";
var weatherData = [sunny, sunny, sunny, cloud, sunny, sunny, sunny, sunny, sunny, cloud, sunny, sunny, sunny, sunny, sunny, sunny, cloud, cloud, sunny, rain, rain, cloud, rain, cloud, cloud, cloud, sunny, sunny, sunny, sunny, sunny, sunny, sunny, sunny, sunny, sunny];
...
class BayesNet {
  constructor(weatherData) {
    ...
    this.pA = [{sunny:this.calculatePa(0, sunny), cloud:this.calculatePa(0, cloud), rain:this.calculatePa(0, rain)},
               {sunny:this.calculatePa(1, sunny), cloud:this.calculatePa(1, cloud), rain:this.calculatePa(1, rain)},
               {sunny:this.calculatePa(2, sunny), cloud:this.calculatePa(2, cloud), rain:this.calculatePa(2, rain)},
               {sunny:this.calculatePa(3, sunny), cloud:this.calculatePa(3, cloud), rain:this.calculatePa(3, rain)}];
    this.pB  = {sunny:this.calculatePa(4, sunny), cloud:this.calculatePa(4, cloud), rain:this.calculatePa(4, rain)};
    this.pAB = {sunny:[{sunny:this.calculatePab(0,sunny,sunny),
                           cloud:   this.calculatePab(0,cloud,sunny),
                           rain:    this.calculatePab(0,rain,sunny)},
                          {sunny:this.calculatePab(1,sunny,sunny),
                           cloud:   this.calculatePab(1,cloud,sunny),
                           rain:    this.calculatePab(1,rain,sunny)},
                          {sunny:this.calculatePab(2,sunny,sunny),
                           cloud:   this.calculatePab(2,cloud,sunny),
                           rain:    this.calculatePab(2,rain,sunny)},
                          {sunny:this.calculatePab(3,sunny,sunny),
                           cloud:   this.calculatePab(3,cloud,sunny),
                           rain:    this.calculatePab(3,rain,sunny)}],
                
                cloud:   [{sunny:this.calculatePab(0,sunny,cloud),
                           cloud:   this.calculatePab(0,cloud,cloud),
                           rain:    this.calculatePab(0,rain,cloud)},
                          {sunny:this.calculatePab(1,sunny,cloud),
                           cloud:   this.calculatePab(1,cloud,cloud),
                           rain:    this.calculatePab(1,rain,cloud)},
                          {sunny:this.calculatePab(2,sunny,cloud),
                           cloud:   this.calculatePab(2,cloud,cloud),
                           rain:    this.calculatePab(2,rain,cloud)},
                          {sunny:this.calculatePab(3,sunny,cloud),
                           cloud:   this.calculatePab(3,cloud,cloud),
                           rain:    this.calculatePab(3,rain,cloud)}],

                rain:    [{sunny:this.calculatePab(0,sunny,rain),
                           cloud:   this.calculatePab(0,cloud,rain),
                           rain:    this.calculatePab(0,rain,rain)},
                          {sunny:this.calculatePab(1,sunny,rain),
                           cloud:   this.calculatePab(1,cloud,rain),
                           rain:    this.calculatePab(1,rain,rain)},
                          {sunny:this.calculatePab(2,sunny,rain),
                           cloud:   this.calculatePab(2,cloud,rain),
                           rain:    this.calculatePab(2,rain,rain)},
                          {sunny:this.calculatePab(3,sunny,rain),
  ...
  reason() {
    let results = new Map([[sunny, this.calculateResult(sunny)],
